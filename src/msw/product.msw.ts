...
const productRes = {
  ...
  data: {
    ...
    updatedAt: '2024-06-27T13:57:10.754Z'
  }
}
...
export const productRequest = http.get(`${config.baseURL}products/:id`, () => {
  return HttpResponse.json(productRes, { status: HttpStatusCode.Ok })
})

const productRequests = [productsRequest, productRequest]
